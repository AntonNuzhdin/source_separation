...
def load_args(default_config=None):
    ...
    # -- model config
    parser.add_argument('--backbone-type', type=str, default='resnet',
                        choices=['resnet', 'shufflenet'], help='Architecture used for backbone')
    ...
    parser.add_argument(
        '--allow-size-mismatch', default=False, action='store_true',
    ...
    parser.add_argument(
        '--mouth-patch-path', type=str, default=None,
...
def main():
    ...
    if args.model_path:
        ...
        logger.info(f'Lipreading model has been successfully loaded from {args.model_path}')
